...
- **Cross-L2 Arbitrage**: Med likviditetsfragmentering på Base, Arbitrum och Optimism krävs blixtsnabb cross-chain bryggning. Användning av "shared sequencers" kan vara en vinnande väg.
